...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var obj = {nombre: nombre, edad: edad, meow:function(){return 'Meow!'}};
   return obj;
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar True. Caso contrario, False.
   // Tu código:
   // hasOwnProperty()  verifica si existe alguna propiedad con el parametro asignado
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // Retornar el objeto.
   // Tu código:
   // como objetoUsuario.amigos es un array podemos agregarlo directamente
