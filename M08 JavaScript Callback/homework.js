...
function mayuscula(nombre) {
   ...
   // [Ejemplo]: "mario" ----> "Mario".
   // Tu código:
   // chartAt() te ayuda a obtener la letra que le digamos
   // toUpperCase() convierte el string en mayuscula
   let primeraLetra = nombre.charAt(0);
   let letraMayuscula = primeraLetra.toUpperCase();
   let restoDelString = nombre.slice(1,nombre.length);
    let stringSalida = letraMayuscula + restoDelString;
   return stringSalida;
}
...
function filter(arrayOfStrings) {
   ...
   // Tu código:
   let newArray = arrayOfStrings.filter(function(index){
      return index[0] == 'a';
   }); 
   return newArray;
}
